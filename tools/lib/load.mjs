...
export const ITEM_DIRS = new Set(['rules', 'decisions', 'contracts', 'assumptions', 'nfr', 'risks', 'issues', 'migrations'])
...
export const ID_PATTERN = /\b(?:BR|ADR|CT|NFR|ASM|RISK|ISS|MIG)-[0-9]{3,}\b/g
